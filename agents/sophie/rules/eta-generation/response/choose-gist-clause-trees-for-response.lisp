(READRULES '*paraphrase*
'(
  1 (!expr !expr) ; previous user gist clause + Eta gist clause to paraphrase
    2 (*basic-paraphrases* 2) (0 :subtree+clause)
  1 (!expr !expr)
    2 ((*gist-clause-trees-for-response* 2) 1) (0 :subtrees)
  1 (!expr !expr)
    2 2 (0 :out)
))
...
'(
  ...
  1 (I am taking lortab every .THREE hours 1)
    2 (*response-tree-lortab-frequency*) (0 :raw)
  1 (I .KNOW that my cancer has gotten worse \, but i\'m not sure how .BAD it is 1)
    2 (*response-tree-understanding-of-condition*) (0 :raw)
  ...
  1 (I .WANT to .TALK about my prognosis today 1)
    2 (*response-tree-redirect-to-prognosis*) (0 :raw)
))


(READRULES '*basic-paraphrases*
'(
