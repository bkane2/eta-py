...
'(
  ...
  ;; ;;   2 ask-about-prognosis.v (3 :schema)
...
; ``````````````````````````````````````````````````````````````````
  ...
  1 (:or
    (0 addiction is not a side .EFFECT of the medication 0)
    (0 a side .EFFECT of the medication .BE 2 .SIDE-EFFECTS-SIGNIFICANT 0)
    (0 a side .EFFECT of the medication .BE 2 .SIDE-EFFECTS-MODERATE 0)
    (0 a side .EFFECT of the medication .BE 2 .SIDE-EFFECTS-INSIGNIFICANT 0)
    )
...
; ``````````````````````````````````````````````````````````````````
  ...
  1 (0 .THINK-GEN 1 should 1 .REVISIT 1 conversation .LATER-TIME 0)
    2 say-ready-to-resume-conversation-later.v (100 :schema)
...
; ``````````````````````````````````````````````````````````````````
  ...
  1 (:or
    (0 a stronger .PAIN medication will .HELP me .SLEEP 0)
    (0 I .SHOULD .TAKE stronger .PAIN medication 0)
    (0 I .SHOULD .TAKE something different 0)
    (0 I .SHOULD .TAKE stronger .PAIN medication 0)
    )
...
; ``````````````````````````````````````````````````````````````````
  ...
  1 (:or
    (0 I .SHOULD .TAKE 1 .MED-NARCOTIC 0)
    (0 I .SHOULD .TAKE .MED-NARCOTIC 0)
    )
...
; ``````````````````````````````````````````````````````````````````
  ...
  1 (:or
    (0 I .SHOULD .TELL .SOMEONE .CLOSE to me about the cancer 0)
    (0 you empathize with how hard it is for me to .TELL my .FAMILY 0)
    (0 my .FAMILY is .IMPORTANT to me 0)
    (0 I .KNOW the best way to .TELL my .FAMILY about my cancer 0)
    )
...
; ``````````````````````````````````````````````````````````````````
  ...
  1 (0 .DOCTOR-PRON 1 .ADMIRE 2 .HAVE 1 .PROGNOSIS-DEALING with 1 .CANCER-ILLNESS 0)
    2 say-appreciate-doctor-words.v (100 :schema)
