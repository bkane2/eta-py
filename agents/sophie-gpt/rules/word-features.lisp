...
'(
  ...
  (ANYONE anybody)
  (SOMEONE person FRIEND ANYONE somebody)
  (MENTION say)
  ...
  (FRIGHTENING scary worrisome upsetting distressing stressful troubling concerning daunting alarming disturbing)
  ...
  (FEAR-SING fear worry anxiety misgiving)
  ...
  (OPTION options)
  (CONVERSATION discussion session meeting)
  ...
  (COMFORT comfortable)
  (FACT facts truth)
  (HONESTY-WORD HONEST HONEST-ADV FACT)
  (EVERYTHING all full whole entire)
  (SUCCUMB DIE victim)
  (STOP stopped prevent prevented keep kept)
  (CHANGE changed changing changes alter alters altering altered transform transforms transforming transformed effect effects affect)
  (CHANGE-IMPROVE CHANGE MAKE-BETTER)
  ...
  (RECOGNIZE realize)
  (REPHRASE reword repeat reiterate)
  (JOIN reach meet)
  (NOT-DETAILED basic basics main crux gist abridged rough outline)
  (ONLY just)
  (SUPPORT supports)
  (DEATH death die dying pass passing)
  (RELIGION religion faith spirituality belief beliefs)
  (PART part role place)
  (AVOID avoid away steer)
  (METASTATIC metastatic widespread aggressive extensive rampant everywhere)
  (SEVERE severe acute serious critical grave grievous drastic massive)
  (IRREPAIRABLE irrepairable irreversible unrepairable untreatable lasting permanent)
  (REVISIT revisit resume continue)
  (POSSIBLE possible conceivable viable)
  (EFFORT effort efforts energy energies work power powers)
  (STATE state condition shape)
  (RESUSCITATE resuscitate resuscitated resuscitation resuscitations revive revived defibrillate defibrillated defibrillation defibrillations)
  ...
  (THINK-GEN think thinking thoughts THOUGHT feel feelings FEELING BELIEVE find finding)
  (UNDERSTANDING-GEN following comprehending understanding)
  (UNDERSTAND-GEN KNOW-GEN THINK-GEN follow comprehend UNDERSTANDING-GEN RECOGNIZE)
  ...
  (FAMILY PARENT siblings sibling grandparents relative GRANDCHILD CHILD)
  ...
  (FREQ-WORD UNUSUAL USUAL chance)
  ...
  (EXPERTISE expert doctor professional experienced experience specialist)
  (LUCKY luck fortune fortunate blessed)
  (FUTURE-POSS MIGHT will would)
  (YOUR-REF your the)
  (MY-REF me my the)
  (WE-REF we you)
  (YOU-REF YOUR-REF you)
  (INSTEAD before)
  ...
  (HABIT habits behavior behaviors routine routines)
  (ADDRESS addressing HEAR LISTEN)
  (HANDLE process digest COPE)
  (TRUST believe)
  (RECOMMENDATION recommendation advice guidance proposal suggestion tip tips)
  (HANDLING-WELL grace poise intelligence kindness clarity insight patience tolerance decency)
  (HANDLING-WELL-ADV impressively admirably)
  (ADMIRE admire applaud praise commend esteem compliment appreciate)
  (IMPRESSED impressed admiring inspired overcome amazed astonished)
  (AMAZE amaze amazes amazed astonish astonishes astonished impress impressed impresses inspire inspires inspired)
  ; Medical history
  ...
  (CANCER-GOALS goal goals objective objectives priority priorities prioritize preference preferences value values valuing hope hopes dream dreams)
  ...
  (LATER-TIME later tomorrow future)
  ; Chemotherapy
  ...
  (DIAGNOSIS-TESTS diagnosis test tests RESULT results study studies scan scans situation)
  (DIAGNOSIS-MORE more other another further additional)
  (DIAGNOSIS-INDICATE indicate mean show reveal tell)
  ; Mental health
  ...
  (MED-ADDICTION addiction addicting addicted abuse hooked dependent)
  (MED-NARCOTIC narcotic narcotics oxycodone morphine)
  (MED-CHEMOTHERAPY carboplatin gemcitabine denosumab zometa)
  (MED-MENT-HEALTH ANTIDEPRESSANT)
  (BLOOD-PRESSURE-MED cozar)
  (SLEEP-MEDICATION ambien nyquil lunesta)
  (MED-GIVE RECOMMEND ADVISE SUGGEST GIVE PRESCRIBE)
  (MED-TAKE TAKE taking get getting use using on prescribed receive receiving HAVE)
  (MED-PAST took taken used got gotten prescribed received had)
  ...
  (PAINFUL unpleasant distressing uncomfortable)
  (PAIN PAINFUL unpleasantness suffering agony affliction discomfort HURT)
  (MAKE-WORSE worse worsen worsening harm harming HURT)
  (PAIN-ALLEVIATE treat manage control alleviate reduce ease help relieve lessen diminish allay assuage palliate moderate mollify IMPROVE relieving improving lessening palliating alleviating controlling managing)
  ; Radiation
  ...
  (DEBILITATE debilitating debilitated debilitates harm harms harming harmed HURT weaken weakens weakened weakening)
