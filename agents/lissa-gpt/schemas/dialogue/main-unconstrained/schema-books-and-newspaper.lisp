;; *discuss-books-and-newspaper*: development version 5 (UNDER CONSTRUCTION)
;;
;; After defining *discuss-books-and-newspaper*, we create a hash table 
;;       *output-semantics* 
;; containing interpretations of Lissa outputs, under hash keys 
;; like (*discuss-books-and-newspaper* ?e1). The main goal is to be able later
;; to match certain user inputs to question interpretations, to
;; see if the inputs already answer the questions, making them
;; redundant.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(store-schema 'discuss-books-and-newspaper-unconstrained.v

'(dial-schema :header (((set-of ^me ^you) discuss-books-and-newspaper-unconstrained.v) ** ?e)
;````````````````````````````````````````````````````````````````````````````````````
...
)) ; END discuss-books-and-newspaper-unconstrained.v